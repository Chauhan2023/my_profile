          ...
          <div className="relative z-10 py-16 md:py-32">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 xl:gap-20">
              ...
              <div className="w-full lg:max-w-md flex flex-col gap-0 xl:gap-8">
                {information.education.map((value, index) => {
                  return (
                    <div key={index} className="flex items-start gap-6">
                      ...
                      <div className="flex-1 flex flex-col gap-2">
                        ...
                        <p className="font-normal text-lg">{value.degree}</p>
                        <p className="text-secondary">
                          {value.year} | {value.location}
                        </p>
                      </div>
                    </div>
                  );
              ...
              <div className="grid grid-cols-2 xs:grid-cols-3 gap-5 xl:gap-7 w-full">
                {information.skills.map((value, index) => {
                  return (
                    <div
                      key={index}
                      className="p-4 xl:p-6 border border-softGray rounded-lg flex flex-col gap-5 sm:gap-10 items-center justify-between hover:shadow-lg transition-all duration-300 bg-white group"
                    >
                      <div className="flex flex-col items-center gap-5">
                        <div className="w-[70px] h-[70px] relative flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                          <Image
